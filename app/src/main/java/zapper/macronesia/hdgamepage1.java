...
public class hdgamepage1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hdgamepage1);
    }
    ...
    public void nextText (View v){
        ...
        if (counter == 1){
            image.setImageResource(R.drawable.hdepilepticdolphin);
        }

        if (counter == 7){
            image.setImageResource(R.drawable.hdepilepticdolphin2);
        }
        ...
        if (counter == 21){
            Intent Choice1 = new Intent(this,hdchoice1.class);
