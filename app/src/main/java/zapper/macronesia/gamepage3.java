...
public class gamepage3 extends AppCompatActivity {
    ...
    public void nextText (View v){
        ...
        if (counter == 2){
            image.setImageResource(R.drawable.badend1);
        }

        if (counter == 12){
            image.setImageResource(R.drawable.badend2);
        }

        if (counter == 14){
            image.setImageResource(R.drawable.badend3);
        }

        if (counter == 16){
            image.setImageResource(R.drawable.badend4);
        }

        if (counter == 17){
            image.setImageResource(R.drawable.badend5);
        }

        if (counter == 19){
            image.setImageResource(R.drawable.badend6);
        }

        if (counter == 20){
            image.setImageResource(R.drawable.badend7);
        }

        if (counter == 21){
            Intent Badend1 = new Intent(this,badend.class);
            startActivity(Badend1);
            finish();
        }

        if (counter == 24){
            image.setImageResource(R.drawable.mahreo2);
        }

        if (counter == 30){
            image.setImageResource(R.drawable.mahreo3);
        }
        ...
        if (counter == 54){
            image.setImageResource(R.drawable.goodend1);
        }

        if (counter == 73){
            Intent Goodend1 = new Intent(this,goodend.class);
