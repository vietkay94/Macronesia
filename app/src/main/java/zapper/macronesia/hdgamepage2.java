...
public class hdgamepage2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hdgamepage2);
    }
    ...
    public void nextText (View v){
        ...
        if (counter == 6){
            image.setImageResource(R.drawable.hddoorkaisad);
        }

        if (counter == 5){
            image.setImageResource(R.drawable.hddoorkai);
            subCounter++;
        }

        if (counter == 4){
            image.setImageResource(R.drawable.hddoorkaihappy);
        ...
        if (counter == 7){
            image.setImageResource(R.drawable.hddoor);
        }

        if (counter == 8){
            image.setImageResource(R.drawable.hdwalteradams);
        }

        if (counter == 10){
            image.setImageResource(R.drawable.hdwalteradamssleep);
        }
        ...
        if (counter == 13){
            image.setImageResource(R.drawable.hddoordark);
        }

        if (counter == 15){
            image.setImageResource(R.drawable.hdstorm1);
        }

        if (counter == 17){
            image.setImageResource(R.drawable.hdstorm2);
        }

        if (counter == 24){
            image.setImageResource(R.drawable.hdstorm3);
        }
        ...
        if (counter == 30){
            image.setImageResource(R.drawable.hdbeach1);
        }
        ...
        if (counter == 36){
            image.setImageResource(R.drawable.hdbeach2compass);
        }
        ...
        if (counter == 40){
            image.setImageResource(R.drawable.hdbeachkai1);
        }

        if (counter == 45){
            image.setImageResource(R.drawable.hdbeachkai2);
        }

        if (counter == 49){
            image.setImageResource(R.drawable.hdbeachkai3);
        }
        ...
        if (counter == 52){
            image.setImageResource(R.drawable.hdbeachkai4);
        }

        if (counter == 53){
            image.setImageResource(R.drawable.hdbeachkai5);
        }

        if (counter == 57){
            image.setImageResource(R.drawable.hdmahreo1);
        }

        if (counter == 69){
            Intent Choice2 = new Intent(this,hdchoice2.class);
